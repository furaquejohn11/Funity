    ...
    <>
      ...
      <main className="sn-main">
          ...
          <div>
            ...
            {/* 17 sdg descriptions */}
            {/* goal 1 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-1'>
            ...
            {/* goal 2 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-2'>
            ...
            {/* goal 3 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-3'>
            ...
            {/* goal 4 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-4'>
            ...
            {/* goal 5 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-5'>
            ...
            {/* goal 6 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-6'>
            ...
            {/* goal 7 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-7'>
            ...
            {/* goal 8 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-8'>
            ...
            {/* goal 9 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-9'>
            ...
            {/* goal 10 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-10'>
            ...
            {/* goal 11 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-11'>
            ...
            {/* goal 12 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-12'>
            ...
            {/* goal 13 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-13'>
            ...
            {/* goal 14 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-14'>
            ...
            {/* goal 15 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-15'>
            ...
            {/* goal 16 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-16'>
            ...
            {/* goal 17 */}
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id='goal-17'>
            ...
            <div className="leaves w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top">
            ...
            <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top-med" id="connect">
            ...
            {/* <!-- take action section --> */}
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 m-top" id="action">
                <div className="e-card-wave playing-wave w-full">
                    <div className="wave"></div>
                    <div className="wave"></div>
                    <div className="wave"></div>
                    

                    <div className="infotop-wave">
                        <div className="space-y-3">
                        ...
                        <div className="name-wave">
                            <div className="mx-auto max-w-[400px] flex flex-col gap-4 md:items-center md:max-w-none md:gap-8 lg:gap-10">
